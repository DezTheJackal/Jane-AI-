# Fixed installation commands (run these in terminal/command prompt):
# pip install pyttsx3
...
def Take_query():
    ...
    while(True):
        ...
        if "open gmail" in query:
            ...
            speak("ok i will show how i look with the browser")
            ...
            webbrowser.open("https://www.paypal.com/")  # Fixed typo: webrowser -> webbrowser
            continue
        ...
        # this will exit and terminate the program
            ...
            try:
                ...
                print(f"Options: {e.options[:5]}")  # Show first 5 options
